...
```{r pca, echo=FALSE, out.width="100%", fig.align='center'}
knitr::include_graphics("data/pca3d.jpg")
```
  
```{r DE, echo=FALSE, out.width="100%", fig.align='center'}
knitr::include_graphics("data/DEgenes.gif")
```
...
```{r cl1, echo=FALSE, out.width="100%", fig.align='center'}
knitr::include_graphics("data/C1_type.jpg")
```

```{r enrcihcl1, echo=FALSE, out.width="100%", fig.align='center'}
knitr::include_graphics("data/Enrich4.jpeg")
```


Cluster 2:  
```{r cl2, echo=FALSE, out.width="100%", fig.align='center'}
knitr::include_graphics("data/C2_type.jpg")
```

```{r enrichcl2, echo=FALSE, out.width="100%", fig.align='center'}
knitr::include_graphics("data/Enrich3.jpeg")
```


Cluster 3: 
```{r cl3, echo=FALSE, out.width="100%", fig.align='center'}
knitr::include_graphics("data/C3_type.jpg")
```

```{r enrichcl3, echo=FALSE, out.width="100%", fig.align='center'}
knitr::include_graphics("data/Enrich2.jpeg")
```


Cluster 4:
```{r cl4, echo=FALSE, out.width="100%", fig.align='center'}
knitr::include_graphics("data/C4_type.jpg")
```

```{r enrichcl1, echo=FALSE, out.width="100%", fig.align='center'}
knitr::include_graphics("data/Enrich1.jpeg")
```
